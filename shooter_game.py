...
lost  = text2.render("YOU LOSE!", True, (249,100,30),(200,74,1))
...
def menu():
    global w, h
    background_menu = transform.scale(image.load('galaxy.jpg'), (w, h))
    menu = True
    while menu:
        ...
        if not finish:
            ...
            if rel_time:
                ...
                if now_time - last_time < 3:
                    reload = text1.render(
                        "Wait, reloading...", 1, (127, 211,123), (165, 65, 35))
